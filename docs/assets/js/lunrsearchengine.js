...
var documents = [{
    "id": 0,
    "url": "https://kaloyanm.github.io/404.html",
    "title": "404",
    "body": "404 Page not found!Please use the search bar from the bottom left or visit our homepage! "
    }, {
    "id": 1,
    "url": "https://kaloyanm.github.io/about",
    ...
    "id": 2,
    "url": "https://kaloyanm.github.io/authors",
    "title": "Authors",
    ...
    "id": 3,
    "url": "https://kaloyanm.github.io/categories",
    "title": "Categories",
    "body": ""
    }, {
    "id": 4,
    "url": "https://kaloyanm.github.io/contact",
    "title": "Contact",
    "body": "  Please send your message to {{site. name}}. We will reply as soon as possible!   "
    }, {
    "id": 5,
    "url": "https://kaloyanm.github.io/",
    "title": "Home",
    "body": "  {% for post in paginator. posts %}    {% include postbox. html %}  {% endfor %}  {% include pagination. html %}"
    }, {
    "id": 6,
    "url": "https://kaloyanm.github.io/robots.txt",
    "title": "",
    "body": "      Sitemap: {{ “sitemap. xml”   absolute_url }}   "
    }, {
    "id": 7,
    "url": "https://kaloyanm.github.io/page2/",
    "title": "Home",
    "body": "  {% for post in paginator. posts %}    {% include postbox. html %}  {% endfor %}  {% include pagination. html %}"
    }, {
    "id": 8,
    "url": "https://kaloyanm.github.io/magma-under-syberia/",
    "title": "ПЪРВОПРИЧИНАТА ЗА НЕПРЕДВИДИМИТЕ ПРОМЕНИ ВЪВ ВРЕМЕТО",
    "body": "2024/05/15 - Климатът става хаотичен и е все по-невъзможно да се предвиди поведението му. Сезоните си сменят местата. Необичайни метеорологични аномалии се случват навсякъде. И ако се появят в региона, в който живеете, тогава знайте че първопричината за всички промени в климата е издигането на магма към земната кора по целия свят. Нагряването на долните слоеве на атмосферата, океаните и ледниците свидетелства за издигането на магмата и образуването на нови магмени потоци, които разяждат мантията и се приближават до кората. Световни институти за изследване на атмосферата са установили, че един от регионите, където повишаването на температурата е 2-3 пъти по-бързо от средното за света, е Сибир. Установено било, че през 1998 г. ядрото на планетата се е изместило в тази посока. Поради това магмата под Сибир се издига най-бързо към повърхността. И сега под него има огромна магмена камера, която си проправя път през кората. Нагряването на недрата води до аномално размразяване на вечната замръзналост и газови експлозии под леда. В арктическата част на Сибир са се появили зимни пожари под снега. В зоните над разломите ледената вода в кладенците на хората става гореща, увеличава се броят и силата на земетресенията. Друг признак за аномално нагряване на почвата е топенето на ледниците отдолу нагоре. Американският геолог и изследовател Джеймс Камис отбелязва, че в Антарктида ледниците Туейтс и Пайн Айлънд се топят отдолу поради увеличения топлинен поток от недрата. В Западна Антарктика, която е вулканична област, топлинни аномалии се появиха под лед с дебелина 2 километра, точно на местата на вулканите. Това е така, защото от 1995 г. се е активирала огромна магмена камера дълбоко под тънката кора на Антарктида в района на Земята Мери Бърд. Подобна ситуация се наблюдава и в Гренландия под централната част на острова. От 1995 г. се е активирала магмена камера, която увеличава скоростта на топене на леда независимо от сезона. Друг много опасен признак за издигането на магмата е нагряването на океанското дъно отдолу. Магмата, която е започнала да се издига от дълбините в огромни мащаби, се вгражда в океанската кора, подобно на червей, който прояжда кората на дърво. Това кара водата на дъното да се нагрява и да се издига на повърхността. Като цяло през последните 30 години това нагряване е с 450% по-голямо и по-бързо в сравнение с предишния период. В резултат както средните слоеве на океана, така и дълбоките слоеве от 4 km и по-надолу се затоплят много по-бързо, отколкото би трябвало. А през лятото на 2023 г. всички възможни рекорди за нагряване на океана бяха счупени. Това затопляне на океана увеличава количеството пара в атмосферата, а това води до  увеличаване на броя на ураганите и бурите, увеличаване на количеството на валежите под формата на аномални дъждове, снеговалежи и едра градушка. По подобен начин на континентите поради издигането на магмата подземните води започват да се изпаряват аномално, което води до увеличаване на рекордните валежи и наводнения. Имайки предвид глобалния характер на протичащите процеси и катастрофалния характер на последствията от тях за всеки от нас, сега е изключително важно да се способства за създаването на международен единен научен център за изследване на климатичните промени и начините за тяхното балансиране. Днес трябва да направим темата за изучаване на климата във въпрос по целия свят и съвместно да насочим всичките си човешки ресурси към неговото разрешаване. Защото цената му е оцеляването на човечеството. 🧑‍💻 Споделяйте информацията. Абонирайте се за телеграм канала. "
    }, {
    "id": 9,
    "url": "https://kaloyanm.github.io/zem-turkish/",
    "title": "Земетресение в сложна обстановка",
    "body": "2024/02/06 - Измина една година, откакто в Южна Турция се случиха два големи разлома, които предизвикаха силно усетени и опустошителни земетресения. Земетресението в Пазарджик с магнитуд 7,8 беше последвано девет часа по-късно от земетресението в Елбистан с магнитуд 7,5, сега общо известно като земетресенията в Кахраманмараш, на името на един от тежко пострадалите градове. Светът изведнъж беше залят от изображения и видеоклипове на разрушенията. Броят на жертвите в крайна сметка нарасна до близо 60 000. Многобройните вторични трусове продължават по протежение и на двете сложни зони на разломите, които са се образували. Последният забележим трус се случи преди по-малко от две седмици: трус с магнитуд 5,2 близо до Малатия, който предизвика силно разтърсване близо до епицентъра си и беше усетен в целия регион. Досега са регистрирани повече от 18 000 труса, въпреки че повечето са били твърде малки, за да бъдат усетени. Земетресенията в Кахраманмараш предизвикаха широк спектър от повърхностни ефекти, включително повърхностни разломи, свлачища, скални падания, втечняване, хидроложки промени, щети на сгради и разрушаване на критично важна инфраструктура. "
    }, {
    "id": 10,
    "url": "https://kaloyanm.github.io/one-day-just-started-adventure/",
    ...
    "id": 11,
    "url": "https://kaloyanm.github.io/london/",
    ...
    "id": 12,
    "url": "https://kaloyanm.github.io/external-featured-image/",
    ...
    "id": 13,
    "url": "https://kaloyanm.github.io/post-with-spoiler/",
    ...
    "id": 14,
    "url": "https://kaloyanm.github.io/that-day-we-almost-missed-flight/",
    ...
    "id": 15,
    "url": "https://kaloyanm.github.io/review-oscar/",
    ...
    "id": 16,
    "url": "https://kaloyanm.github.io/french-wine/",
    ...
    "id": 17,
    "url": "https://kaloyanm.github.io/the-observer/",
    ...
    "id": 18,
    "url": "https://kaloyanm.github.io/press-and-education/",
    ...
    "id": 19,
    "url": "https://kaloyanm.github.io/education/",
